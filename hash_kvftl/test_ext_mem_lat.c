...
void show_stats()
{
    ...
    ftl_log("valid hot entries: %d , valid hot pages: %d, hot collision: %d\n", d_cache.member.hot_entries, (int)(d_cache.member.hot_entries / EPP), d_cache.stat.hot_cmt_hit_by_collision);
    // for (int i = 0; i < 64; ++i) {
